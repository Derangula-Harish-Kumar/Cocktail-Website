...
const Images = () => {
  ...
  return (
    <div ref={container} className='w-screen h-auto grid grid-cols-1 lg:grid-cols-4 lg:grid-flow-dense p-5'>
      ...
      */}
      <div className="image-card opacity-0 translate-y-24 bg-[url('/images/abt1.png')] bg-cover bg-center h-100 w-[90%] m-5 rounded-4xl"></div>
